...
using Gabog.WebChatHost.Models;
...
namespace Gabog.WebChatHost.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public HomeController(ICredentialProvider provider, IConfiguration configuration)
        {
            ...
            _webchatSecret = configuration.GetSection("WebChatSecret").Value;
            ...
            _bingSpeechKey = configuration.GetSection("BingSpeechKey").Value;
        ...
        public IActionResult WebChatV3()
        {
            // Get DirectLine Token
            // Pass the DirectLine Token, Speech Key and Voice Name
            // Note this approach will require magic code validation
